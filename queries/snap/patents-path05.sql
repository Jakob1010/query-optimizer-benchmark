...
postgresql('localhost:5432', 'snap', 'patents', 'snap', 'snap', 'public') p6
where p1.tonode = p2.fromnode AND p2.tonode = p3.fromnode AND p3.tonode = p4.fromnode AND p4.tonode = p5.fromnode AND p5.tonode = p6.fromnode
